...
import (
	...
	viewv1 "github.com/kn5suzuki/kubebuilder_markdown_view/api/v1"
)
...
//! [rbac]
//+kubebuilder:rbac:groups=view.kn5suzuki.github.io,resources=markdownviews,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=view.kn5suzuki.github.io,resources=markdownviews/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=view.kn5suzuki.github.io,resources=markdownviews/finalizers,verbs=update
